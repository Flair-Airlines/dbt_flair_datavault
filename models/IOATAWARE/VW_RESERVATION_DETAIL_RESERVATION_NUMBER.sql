...
t7.STR_IDENT||'-'||t6.STR_IDENT AS "Route Pair",
...
LEFT JOIN {{ source('PSS_AMELIARES_DBO', 'TBL_USERS') }}  AS t16 ON t16.lng_User_Id_Nmbr = t1.LNG_CREATION_USER_ID_NMBR and t16._FIVETRAN_DELETED = 'FALSE'

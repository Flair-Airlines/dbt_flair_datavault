...
--left join {{ source('PSS_AMELIARES_DBO', 'TBL_SKED_FLIGHT_WATCH_JOURNEY_LOG') }} t11 on t11.LNG_SKED_DETAIL_ID_NMBR = t5.LNG_SKED_DETAIL_ID_NMBR

where "Check In Boarded" = 'B'
--AND "Flight Date" = '2023/05/05'and t5.LNG_SKED_DETAIL_ID_NMBR =149762;
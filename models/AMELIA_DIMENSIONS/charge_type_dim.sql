...
LNG_GL_CHARGE_TYPE_ID_NMBR as ORIGINAL_SURROGATE_ID_HASH,
TRUE as LATEST_INDICATOR,
CURRENT_TIMESTAMP() as INSERTED_TS,
chrg.CHARGE_CATEGORY_SURROGATE_ID_HASH as CHARGE_CATEGORY_SURROGATE_ID_HASH,
LNG_CHARGE_CATEGORY_ID_NMBR
from 
{{ source('PSS_AMELIARES_DBO' ,'TBL_GL_CHARGE_TYPE_DEFINITION') }} chrg_type
left join {{ ref('charge_category_dim') }} chrg on chrg_type.LNG_CHARGE_CATEGORY_ID_NMBR=chrg.ORIGINAL_SURROGATE_ID_HASH

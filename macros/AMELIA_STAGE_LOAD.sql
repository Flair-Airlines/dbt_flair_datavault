{% macro AMELIA_STAGE_LOAD() %}
  ...
  {% do run_query("call STAGE_DEV.AMELIA_DBO.PROC_STG_GL_PAYMENTS();") %}
  ...
  {% do run_query("call STAGE_DEV.AMELIA_DBO.PROC_STG_RESERVATIONS_ALERTS_TYPE_DEFINITION();") %}
  {% do run_query("call STAGE_DEV.AMELIA_DBO.PROC_STG_RESERVATIONS_ALERTS_CATEGORY();") %}
  {% do run_query("call STAGE_DEV.AMELIA_DBO.PROC_STG_RESERVATIONS_ALERTS_TYPE_CATEGORY_XREF();") %}
  {% do run_query("call STAGE_DEV.AMELIA_DBO.PROC_STG_RESERVATIONS_ALERTS_HEADER();") %}
  {% do run_query("call STAGE_DEV.AMELIA_DBO.PROC_STG_AIRCRAFT_MODEL_DEFINITION();") %}
{% endmacro %}
